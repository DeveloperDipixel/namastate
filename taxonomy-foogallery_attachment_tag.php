...
<?php if(isset($_GET['foogallery_attachment_tag'])): ?>
<?php 
 $getSlug = $_GET['foogallery_attachment_tag'];
 $foo_term = get_term_by('slug', strtolower($getSlug), 'foogallery_attachment_tag');
...
$terms = get_terms( array(
    'taxonomy' => 'foogallery_attachment_tag',
    'hide_empty' => false,
) );
...
<div class="container px-0">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav foo-cats">
      <?php if(count($terms1) > 0): ?>
	  <?php foreach($terms1 as $term1): ?>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url().'/?foogallery_attachment_category='.$term1->slug.'&cat_id='.$term1->term_id; ?>"><?php echo $term1->name; ?></a>
      </li>
    <?php endforeach; ?>
	<?php endif; ?>
    </ul>
	...
	<div class="container px-0">
		<div class="category-bg">
			...
			<ul>
				<?php if(count($terms1) > 0): ?>
	  <?php foreach($terms1 as $term1): ?>
				<li class="nav-item"><a class="nav-link" href="<?php echo site_url().'/?foogallery_attachment_category='.$term1->slug.'&cat_id='.$term1->term_id; ?>"><?php echo $term1->name; ?></a></li>
